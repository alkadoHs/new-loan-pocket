...
body {
  ...
  background-size: 100% 100%;
	...
	<div class="login-wrapper">
		...
		<span class="text-success">Employee</span> <span style="color:#ccc; text-shadow:0 1px #fff"></span>
			</h2>
	    </div>
...
<?php endif; ?>
				...
				<div class="panel-body">
						<?php echo form_open("welcome/Employee_signin",['class'=>'form-login']) ?>
						<div class="form-group">
							<label>Phone Number</label>
							<input type="number" placeholder="Enter Your phone number" name="empl_no" class="form-control input-lg " required  autocomplete="off">
							<?php echo form_error("empl_no") ?>
						</div>
						...
						<div class="text-center">
							<button type="submit" class="btn btn-success">Login</button> </b>
						</div>
					<?php echo form_close(); ?>
